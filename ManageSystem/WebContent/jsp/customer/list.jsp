										...
										<TBODY>
											...
											<c:forEach items="${pageBean.list}" var="customer">
												<TR
													...
													<TD><s:if test="#parameters.choose==null">
															<a
																href="${pageContext.request.contextPath }/customer_edit.action?cust_id=${customer.cust_id }">修改</a>
														&nbsp;&nbsp; <a
																href="${pageContext.request.contextPath }/customer_delete.action?cust_id=${customer.cust_id }">删除</a>
														</s:if> <s:else>
