...
public class Customer {
    ...
    private Set<SaleVisit> seleVisits=new HashSet<SaleVisit>();
	public Set<SaleVisit> getSeleVisits() {
		return seleVisits;
	}

	public void setSeleVisits(Set<SaleVisit> seleVisits) {
		this.seleVisits = seleVisits;
	}
